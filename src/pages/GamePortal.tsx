...
import { Search, Grid3X3, Archive, Cpu, Sparkles, X, Terminal, Monitor, Download } from 'lucide-react';
        ...
        <div className="min-h-screen bg-background text-foreground pt-32 pb-20 selection:bg-primary/30 overflow-x-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-4xl mx-auto text-center mb-24">
                    ...
                    >
                        A curated collection of digital interfaces and legacy games, preserved in a weightless spatial environment.
                    </motion.p>
                </div>
            ...
            <AnimatePresence>
                {activeGame && (
                    ...
                    >
                        ...
                        <div className="h-20 border-b border-white/10 px-8 flex items-center justify-between bg-black/50">
                            ...
                            <div className="flex items-center gap-4">
                                <Button
                                    ...
                                    className="hidden md:flex gap-2 text-[10px] font-sans font-bold uppercase tracking-widest text-white/60 hover:text-white"
                                >
                        ...
                        {/* Overlay Footer */}
                        <div className="h-12 border-t border-white/5 px-8 flex items-center justify-between text-[9px] font-sans font-bold uppercase tracking-[0.2em] text-white/30">
                            <div className="flex items-center gap-4">
                                <Monitor className="w-3 h-3" />
                                <span>Optimal Resolution: 1920x1080</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                                <span>Interface Synchronized</span>
                            </div>
                        </div>
                    </motion.div>
                )}
